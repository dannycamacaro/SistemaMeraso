 ...
 * @author user
 */
public class frmconsultaPaciente extends javax.swing.JInternalFrame {
    ...
    private void BuscarTodos(){
        ...
        mostrartodos(cbparametro.getSelectedItem().toString(),dato);
    }
    ...
    private void sizetable(){
        try {
            ...
            JOptionPane.showConfirmDialog(rootPane, "Error al ajustar en la tabla");
    ...
    private void mostrar (String parametro,String buscar){
        ...
        private void mostrartodos (String parametro,String buscar){
        try {
            DefaultTableModel modelo;
            String valor;
            String valorfinal;
            ...
            System.out.println(cbparametro.getSelectedItem().toString());
            fpaciente func= new fpaciente();
            modelo=func.mostrarTodosPaciente(valorfinal,buscar);
            tbpaciente.setModel(modelo);
            lblTotal.setText(""+ Integer.toString(func.totalRegistros));  
            //
            sizetable();
    ...
    private void initComponents() {
        ...
        jScrollPane4.setBounds(10, 30, 800, 360);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("TOTAL DE REGISTROS:");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(570, 390, 140, 30);

        lblTotal.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblTotal.setForeground(new java.awt.Color(255, 0, 0));
        lblTotal.setText("0");
        jPanel1.add(lblTotal);
        lblTotal.setBounds(720, 390, 90, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 80, 820, 420);
        ...
        panel2.add(btnmenu);
        btnmenu.setBounds(710, 0, 110, 50);
        ...
        cbparametro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CEDULA", "NOMBRE", "APELLIDO", "TELEFONO" }));
        ...
        cbparametro.setBounds(190, 20, 360, 30);
        ...
        btnbuscar.setBounds(570, 0, 70, 50);
        ...
        panel2.add(btntodos);
        btntodos.setBounds(640, 0, 70, 50);
    ...
    private void tbpacienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbpacienteMousePressed
        ...
        if (evt.getClickCount()==2){
            ...
            try {
                ...
                frmpaciente.txtcodigoPaciente.setText(tbpaciente.getValueAt(fila, 0).toString());
                frmpaciente.txtcedulaPaciente.setText(tbpaciente.getValueAt(fila, 1).toString());
                frmpaciente.txtnombrePaciente.setText(tbpaciente.getValueAt(fila, 2).toString());
                frmpaciente.txtapellidoPaciente1.setText(tbpaciente.getValueAt(fila, 3).toString());
                frmpaciente.jdfechaNacimiento.setDate(Date.valueOf(tbpaciente.getValueAt(fila, 4).toString()));
                frmpaciente.txttelefono.setText(tbpaciente.getValueAt(fila, 5).toString());
                frmpaciente.txtdireccion.setText(tbpaciente.getValueAt(fila, 6).toString());
                String sexo=(String) tbpaciente.getValueAt(fila, 7);
                System.out.println(sexo);
                  if (sexo.equals("MASCULINO")){
                    frmpaciente.cbsexo.setSelectedIndex(0);
                    System.out.println(sexo);
                }
                else{
                    frmpaciente.cbsexo.setSelectedIndex(1);
                    System.out.println(sexo);
                }
                frmpaciente.btneliminar.setEnabled(true);
                frmpaciente.btncancelar.setEnabled(true);
                frmpaciente.btnmodificar.setEnabled(true);
                frmpaciente.btnhabilitar.doClick();
